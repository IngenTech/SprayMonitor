 ...
 * Use the {@link MothWisePerformanceFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MothWisePerformanceFragment extends Fragment {

    public MothWisePerformanceFragment() {
    ...
    public static MothWisePerformanceFragment newInstance() {
        MothWisePerformanceFragment fragment = new MothWisePerformanceFragment();
    ...
    private void performanceRequest() {
        ...
        String methodeName = "monthPerformance";
                            ...
                            if (jsonObject.has("status")) {
                                if (jsonObject.getString("status").equals("success")) {
                                    ...
                                    if (performanceArray.length() > 0) {
                                        ...
                                        villageTxt.setText("No. Of Village");
                                        ...
                                        for (int i = 0; i < performanceArray.length(); i++) {
                                            ...
                                            String dateString = performanceObject.getString("month");
                                            String villageString = performanceObject.getString("noOfVillage");
