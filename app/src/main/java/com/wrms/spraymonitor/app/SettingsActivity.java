...
//        setupActionBar();
        ...
        intent.putExtra( PreferenceActivity.EXTRA_SHOW_FRAGMENT, DataSyncPreferenceFragment.class.getName() );
    ...
    public static class LanguagePreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("language_pref_key"));
        }
    ...
    public static class DataSyncPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_data_settings);
            setHasOptionsMenu(true);
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
      //      bindPreferenceSummaryToValue(findPreference("video_transmission"));
